			...
			<div class="ts-slider-wrap {$params.effect}" id="{$slider_id}"
				...
				<div class="ts-control">
					{if $params.display_direction_button}
						<a class="ts-ctr-prev ts-ctr" href="#{$slider_id}" data-jslide="prev"><i class="fa fa-angle-left"></i></a>
					{/if}
					...
					{if $params.display_direction_button}
						<a class="ts-ctr-next ts-ctr" href="#{$slider_id}" data-jslide="next"><i class="fa fa-angle-right"></i></a>
					{/if}
				</div>
				<!--End ts-control-->
			</div>
