		...
		<fieldset>
			...
			<div id="login_form_content" style="display:none;">
				...
				<p class="submit">
                    ...
                    <button type="submit" id="SubmitLogin" name="SubmitLogin" class="button btn btn-default button-medium"><span><i class="fa fa-lock left"></i>{l s='Sign in'}</span></button>
				</p>
			</div>
		</fieldset>
	</form>
        	...
        	<div class="box">
                ...
                <div id="opc_account_choice" class="row">
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <p class="opc-button">
                            <button type="submit" class="btn btn-default button button-medium exclusive" id="opc_createAccount"><span><i class="fa fa-user left"></i>{l s='Create an account'}</span></button>
                        </p>
                    </div>
                </div>
				...
				<div class="submit opc-add-save clearfix">
                    ...
                    <button type="submit" name="submitAccount" id="submitAccount" class="btn btn-default button button-medium"><span>{l s='Save'}<i class="fa fa-chevron-right right"></i></span></button>
