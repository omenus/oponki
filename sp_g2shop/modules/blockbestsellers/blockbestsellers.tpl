...
<div id="best-sellers_block_right" class="block products-block col-sm-4">
    ...
    <div class="block_content">
        {if $best_sellers && $best_sellers|@count > 0}
            <ul class="product_images">
                {foreach from=$best_sellers item=product name=myLoop}
                    <li class="{if $smarty.foreach.myLoop.first}first_item{elseif $smarty.foreach.myLoop.last}last_item{else}item{/if} clearfix">
                        <a class="products-block-image content_img clearfix" href="{$product.link|escape:'html'}" title="{$product.legend|escape:'html':'UTF-8'}" >
            ...
            <p class="lnk"><a href="{$link->getPageLink('best-sales')|escape:'html'}"
                              ...
                              class="button_large button">&raquo; {l s='All best sellers' mod='blockbestsellers'}</a></p>
        {else}
