...
{$list = $spnewproducts}
{if isset($list) && $list}
    {assign var="tag_id" value="sp_new_products"}
   
    {assign var="cod_style" value=($params.ctr_pos == 'bottom')?'margin-bottom:40px;':''}
    <div id="{$tag_id}" class="sp-new-products sp-newproducts sp-preload" style="{$cod_style}">
        ...
        {if $params.ctr_pos !="top"}
            {if $params.ctr_dis}
                <div class="page-button {$params.ctr_pos} {$params.ctr_type}">
                    <ul class="control-button">
                        <li class="preview">{l s='Prev' mod='spnewproducts'}</li>
                        <li class="next">{l s='Next' mod='spnewproducts'}</li>
                    </ul>
                </div>
            {/if}
        {/if}
...
{else}
    {l s='Has no content to show!' mod='spnewproducts'}
{/if}	
