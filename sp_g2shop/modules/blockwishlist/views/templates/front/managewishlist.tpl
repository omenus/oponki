			...
			<div class="product-container">
				...
				<div class="clearfix">
					...
					<div class="product_infos">
						...
						{/if}
							<br /> <label style="width:65px;">{l s='Quantity' mod='blockwishlist'}: </label> <input type="text" id="quantity_{$product.id_product}_{$product.id_product_attribute}" value="{$product.quantity|intval}" size="3" style="text-align:center;" />
							<br /><br />
							<label style="width:65px;">{l s='Priority' mod='blockwishlist'}: </label>
							<select style="display:inline-block;width:70%;" id="priority_{$product.id_product}_{$product.id_product_attribute}">
