	...
	<div id="idTab1" class="tab-pane active">
		...
		{if $canSendInvitations}
			...
			<form method="post" action="{$link->getModuleLink('referralprogram', 'program', [], true)|escape:'html':'UTF-8'}" class="std">
				...
				<p class="submit">
                    <button type="submit" id="submitSponsorFriends" name="submitSponsorFriends" class="btn btn-default button button-medium"><span>{l s='Validate' mod='referralprogram'}<i class="fa fa-chevron-right right"></i></span></button>
				</p>
			</form>
		{else}
...
<ul class="footer_links clearfix">
	<li>
		...
		<span><i class="fa fa-chevron-left left"></i> {l s='Back to Your Account' mod='referralprogram'}</span></a>
	</li>
	<li><a class="btn btn-default button button-small" href="{$base_dir}" title="{l s='Home' mod='referralprogram'}"><span><i class="fa fa-chevron-left left"></i>{l s='Home' mod='referralprogram'}</span></a></li>
</ul>
