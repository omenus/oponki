...
<div id="social_block" class="col-sm-4">
	...
	<ul class="social-block ">
		{if $facebook_url != ''}<li class="facebook"><a class="_blank" href="{$facebook_url|escape:html:'UTF-8'}"><i class="fa fa-facebook"></i></a></li>{/if}
		...
		{if $youtube_url != ''}<li class="youtube"><a class="_blank" href="{$youtube_url|escape:html:'UTF-8'}"><i class="fa fa-youtube"></i></a></li>{/if}
		{if $google_plus_url != ''}<li class="google_plus"><a class="_blank" href="{$google_plus_url|escape:html:'UTF-8'}"><i class="fa fa-google"></i></a></li>{/if}
