...
<div id="mailalerts_block_account" class="block">
		...
		<ul class="products-block">
			...
			<li class="clearfix{if $smarty.foreach.myLoop.last} last_item{/if}">
                ...
                <div class="product-content">
                	<span class="remove">
                        <i class="fa fa-remove" rel="ajax_id_mailalert_{$mailAlert.id_product}_{$mailAlert.id_product_attribute}"></i>
                    </span>
	...
	<ul class="footer_links clearfix">
		<li><a class="btn btn-default button button-small" href="{$link->getPageLink('my-account', true)|escape:'html'}" title="{l s='Back to Your Account' mod='mailalerts'}"><span><i class="fa fa-chevron-left left"></i>{l s='Back to Your Account' mod='mailalerts'}</span></a></li>
	</ul>
</div>
