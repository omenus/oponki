...
<div id="content">
   <div itemtype="#" itemscope="" id="sdsblogArticle" class="blog-post">
	...
	<span itemprop="dateCreated" class="dateCreated">Date Created: {$created|date_format}</span>
      ...
      <div itemprop="articleBody">
         ...
         {assign var="catOptions" value=null}
						...
						{l s='Posted in ' mod='smartblog'}<span itemprop="articleSection"><a href="{smartblog::GetSmartBlogLink('smartblog_category',$catOptions)}">{$title_category}</a></span>
               <span>{l s='by' mod='smartblog'} {if $smartshowauthor ==1}<i class="icon icon-user"></i><span class="author" itemprop="author">{if $smartshowauthorstyle != 0}{$firstname} {$lastname}{else}{$lastname} {$firstname}{/if}</span>&nbsp;{/if}&nbsp;
...
<div class="smartblogcomments" id="respond">
	...
	{if Configuration::get('smartcaptchaoption') == '1'}
		...
		<td><span class="required">*</span> <b>{l s="Type Code" mod="smartblog"}</b></td><td><input type="text" tabindex="" value="" name="smartblogcaptcha" class="smartblogcaptcha form-control grey"></td>
		</tr>
	{/if}
	</tbody></table>
	...
	<div class="right">
        ...
        <div class="submit">
            <input type="submit" name="addComment" id="submitComment" class="button btn btn-default button-medium" value="Submit">
		</div>
