...
<section class="footer-account box-footer col-md-2 col-sm-3 col-xs-6">
	<h3 class="mod-title">{l s='My account' mod='blockmyaccountfooter'}</h3>
	<div class="block_content toggle-footer">
		<ul class="list-link">
			...
			<li><a href="{$link->getPageLink('order-follow', true)|escape:'html':'UTF-8'}" title="{l s='My merchandise returns' mod='blockmyaccountfooter'}" rel="nofollow"> {l s='My merchandise returns' mod='blockmyaccountfooter'}</a></li>
			...
			<li><a href="{$link->getPageLink('discount', true)|escape:'html':'UTF-8'}" title="{l s='My vouchers' mod='blockmyaccountfooter'}" rel="nofollow"> {l s='My vouchers' mod='blockmyaccountfooter'}</a></li>
