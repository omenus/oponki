    ...
    <form action="{$link->getModuleLink('bankwire', 'validation', [], true)|escape:'html':'UTF-8'}" method="post">
        ...
        <p class="cart_navigation clearfix" id="cart_navigation">
            ...
            href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html':'UTF-8'}">
                <i class="fa fa-chevron-left left"></i>{l s='Other payment methods' mod='bankwire'}
            </a>
            <button 
            class="button btn btn-default button-medium pull-right" 
            type="submit">
                <span>{l s='I confirm my order' mod='bankwire'}<i class="fa fa-chevron-right right"></i></span>
            </button>
        </p>
    </form>
{/if}
