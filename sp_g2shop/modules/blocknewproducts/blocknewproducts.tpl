...
<div id="new-products_block_home" class="block products_block">
    ...
    <div class="block_content products-block">
        {if $new_products !== false}
            ...
            <div>
                <a href="{$link->getPageLink('new-products')|escape:'html'}" title="{l s='All new products' mod='blocknewproducts'}" class="btn btn-default button button-small"><span>{l s='All new products' mod='blocknewproducts'}<i class="fa fa-chevron-right right"></i></span></a>
            </div>
        {else}
