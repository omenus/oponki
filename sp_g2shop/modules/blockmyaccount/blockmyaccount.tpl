	...
	<div class="block_content list-block">
		<ul>
			<li>
				<a href="{$link->getPageLink('history', true)|escape:'html':'UTF-8'}" title="{l s='My orders' mod='blockmyaccount'}">
					<i class="fa fa-list-ol"></i> {l s='My orders' mod='blockmyaccount'}
				</a>
			</li>
			{if $returnAllowed}
				<li>
		...
		<div class="logout">
			...
			title="{l s='Sign out' mod='blockmyaccount'}">
				<span>{l s='Sign out' mod='blockmyaccount'}<i class="fa fa-chevron-right right"></i></span>
			</a>
		</div>
	</div>
</div>
