								...
								{if isset($product->specificPrice) && $product->specificPrice}
									{if {$product->specificPrice.reduction_type == 'percentage'}}
										...
										<div class="price-percent-reduction">
											...
											<span class="n-sale">{$product->specificPrice.reduction*100|floatval}%</span>
										</div>
									{else}
										<span class="old-price product-price">
										...
										<div class="price-percent-reduction">
											<span class="txt-label">{l s='Save'} </span>
											<span class="n-sale">{convertPrice price=$product->specificPrice.reduction}</span>
										</div>
									{/if}
						...
						<div class="comparison_product_infos">
							...
							<div class="clearfix">
								<div class="button-container">
									...
									<a class="cmp_remove button" href="{$link->getPageLink('products-comparison', true)|escape:'html':'UTF-8'}" title="{l s='Remove'}" data-id-product="{$product->id}">
