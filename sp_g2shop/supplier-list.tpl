				...
				<ul class="display">
					...
					<li id="grid">
						<a rel="nofollow" href="#" title="{l s='Grid'}">
							<i class="fa fa-th-large"></i>{l s='Grid'}
						</a>
					</li>
					<li id="list">
						<a rel="nofollow" href="#" title="{l s='List'}">
							<i class="fa fa-th-list"></i>{l s='List'}
						</a>
					</li>
				</ul>
			{/if}
					...
					<div class="row"> 
						...
						<div class="right-side col-xs-12 col-sm-4">
			            	<div class="right-side-content">
			                    ...
			                    {if $supplier.nb_products > 0}
			                        <a class="btn btn-default button exclusive-medium" href="{$link->getsupplierLink($supplier.id_supplier, $supplier.link_rewrite)|escape:'html':'UTF-8'}"><span>{l s='View products'} <i class="fa fa-chevron-right right"></i></span></a>
			                    {/if}
			                </div>
						</div><!-- .right-side -->
					</div>
