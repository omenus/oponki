...
<div class="page-heading">
	<h1>{if isset($customerThread) && $customerThread}{l s='Your reply'}{else}{l s='Contact us'}{/if}</h1>
	<!--<p>{l s='Browse qua the following product new the we'} </p>-->
</div>
        ...
        <div class="clearfix row">
            ...
            <div class="col-xs-12 col-md-9">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="message" name="message" rows="13" cols="50">{if isset($message)}{$message|escape:'html':'UTF-8'|stripslashes}{/if}</textarea>
                </div>
            </div>
        </div>
        <div class="submit">
            <button type="submit" name="submitMessage" id="submitMessage" class="button ">{l s='Send'}</button>
		</div>
	</fieldset>
</form>
{/if}
