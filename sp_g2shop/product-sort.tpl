...
<ul class="display hidden-xs">
    ...
    <li id="grid"><a rel="nofollow" href="#" title="{l s='Grid'}"><i class="fa fa-th-large"></i></a></li>
    <li id="list"><a rel="nofollow" href="#" title="{l s='List'}"><i class="fa fa-th-list"></i></a></li>
</ul>
...
<form id="productsSortForm{if isset($paginationId)}_{$paginationId}{/if}" action="{$request|escape:'html':'UTF-8'}" class="productsSortForm pull-right">
